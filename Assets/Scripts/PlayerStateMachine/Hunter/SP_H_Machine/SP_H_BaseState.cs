...
public abstract class SP_H_BaseState
{
    private bool _isRootState = false;
    protected SP_H_StateManager _ctx;
    protected SP_H_StateFactory _factory;
    protected SP_H_BaseState _currentSubState;
    private SP_H_BaseState _currentSuperState;

    protected bool hasDoubleJumped;
    public bool HasDoubleJumped { get { return hasDoubleJumped; } set { hasDoubleJumped = value; } }
    protected bool IsRootState { set { _isRootState = value; } }
    public SP_H_BaseState CurrentSubState { get { return _currentSubState; } }
    ...
    public SP_H_BaseState(SP_H_StateManager currentContext, SP_H_StateFactory p_StateFactory)
    {
        _ctx = currentContext;
    ...
    protected void SwitchState(SP_H_BaseState newState)
    {
    ...
    protected void SetSuperState(SP_H_BaseState newSuperState)
    {
        _currentSuperState = newSuperState;
    }

    protected void SetSubState(SP_H_BaseState newSubState)
    {
