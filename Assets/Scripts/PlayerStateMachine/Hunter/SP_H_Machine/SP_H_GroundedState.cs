...
public class SP_H_GroundedState : SP_H_BaseState
{
    Vector3 direction;
    
    public SP_H_GroundedState(SP_H_StateManager currentContext, SP_H_StateFactory p_StateFactory) : base(currentContext, p_StateFactory)
    {
        IsRootState = true;
    }
