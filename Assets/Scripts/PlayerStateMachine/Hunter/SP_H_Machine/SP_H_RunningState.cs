...
public class SP_H_RunningState : SP_H_BaseState
{
    float totalMagnitude;
    float sprintMagnitude;
    public SP_H_RunningState(SP_H_StateManager currentContext, SP_H_StateFactory p_StateFactory) : base(currentContext, p_StateFactory)
    {
