...
public class SP_H_InAirState : SP_H_BaseState
{
    ...
    public SP_H_InAirState(SP_H_StateManager currentContext, SP_H_StateFactory p_StateFactory) : base(currentContext, p_StateFactory)
    {
        IsRootState = true;
    }
