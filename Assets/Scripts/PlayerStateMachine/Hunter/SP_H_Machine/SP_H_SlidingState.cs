...
public class SP_H_SlidingState : SP_H_BaseState
{

    float totalMagnitude;
    float stateMag;

    public SP_H_SlidingState(SP_H_StateManager currentContext, SP_H_StateFactory p_StateFactory) : base(currentContext, p_StateFactory)
    {
