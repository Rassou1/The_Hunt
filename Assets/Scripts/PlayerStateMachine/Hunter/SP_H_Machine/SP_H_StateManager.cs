...
public class SP_H_StateManager : MonoBehaviour
{
    ...
    SP_H_BaseState _currentState;
    SP_H_StateFactory _states;
    ...
    public SP_H_BaseState CurrentState { get { return _currentState; } set { _currentState = value; } }
    ...
    public static SP_H_StateManager Instance { get; internal set; }
    ...
    private void Awake()
    {
        ...
        _states = new SP_H_StateFactory(this);
