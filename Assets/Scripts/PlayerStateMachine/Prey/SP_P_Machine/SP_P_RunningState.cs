...
public class SP_P_RunningState : SP_P_BaseState
{
    float totalMagnitude;
    float sprintMagnitude;
    public SP_P_RunningState(SP_P_StateMachine currentContext, SP_P_StateFactory sp_p_StateFactory) : base(currentContext, sp_p_StateFactory)
    {
