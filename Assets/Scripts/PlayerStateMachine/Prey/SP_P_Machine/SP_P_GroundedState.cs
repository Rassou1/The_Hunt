...
public class SP_P_GroundedState : SP_P_BaseState
{
    Vector3 direction;

    public SP_P_GroundedState(SP_P_StateMachine currentContext, SP_P_StateFactory p_StateFactory) : base(currentContext, p_StateFactory)
    {
        IsRootState = true;
    }
